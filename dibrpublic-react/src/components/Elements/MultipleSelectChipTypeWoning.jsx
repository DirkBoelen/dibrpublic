...
const MultipleSelectChipTypeWoning = ({sx= {}, title = "Chip" }) => {
  const theme = useTheme();
  const [personName, setPersonName] = React.useState(['Woonhuis','Appartement']);
...
export default MultipleSelectChipTypeWoning;
